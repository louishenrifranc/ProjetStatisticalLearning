...
```
Une seule variable a été supprimé du modèle. Il s'agit de sqft_living
...
plot(regfw.subset, scale = "adjr2", main = "R^2 ajusté en fonction des diférents modèles")
```
